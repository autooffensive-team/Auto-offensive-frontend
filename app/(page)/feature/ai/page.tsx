          ...
          <div className="flex flex-col items-center justify-center text-center">
            ...
            >
              ...
              <motion.h1
                variants={fadeUp}
                custom={0}
                className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold mb-6 text-[#18181B] dark:text-white max-w-3xl"
                style={{
          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-2 items-center gap-6 px-8 py-0 sm:px-12 sm:py-0 lg:px-16 lg:py-0 max-w-7xl mx-auto">
            ...
            <div className="order-1 lg:order-2 flex flex-col items-center text-center lg:items-start lg:text-left">
              ...
              >
                ...
                <Link href={toDocsUrl('/ai-analysis')} className="ripple-button inline-flex items-center justify-center gap-2 rounded-xl border border-[rgba(0,208,178,0.28)] dark:border-[rgba(0,208,178,0.2)] bg-white dark:bg-[rgba(0,208,178,0.06)] px-4 py-3 sm:px-6.5 sm:py-3.5 text-[14px] sm:text-[15px] font-medium text-black dark:text-white backdrop-blur-sm duration-200 cursor-pointer hover:bg-white/80">
                  <ExternalLink className="w-4 h-4" />
