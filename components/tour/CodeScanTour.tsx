...
const TOUR_STEPS = [
  ...
  // ── Done ──
  {
    popover: {
      ...
      description:
        'Click <strong>"Import Repo"</strong> to get started. Connect your GitHub or GitLab, pick a repo, and let Auto-Offensive analyze your code.<br/><br/>Click the <strong>Tour Guide</strong> button anytime to replay this walkthrough.',
    },
  },
];
