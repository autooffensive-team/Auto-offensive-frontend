...
const TOUR_STEPS = [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    popover: {
      ...
      description:
        "Start with <strong>Basic mode</strong> to get familiar, then graduate to Medium and Advanced as you grow more comfortable.<br/><br/>Click the <strong>Tour Guide</strong> button anytime to replay this walkthrough. Happy scanning!",
    },
    onHighlightStarted: () => { clickTab("tab-basic"); },
  },
];
