...
const TOUR_STEPS = [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    popover: {
      ...
      description:
        "Remember: select a <strong>project first</strong>, then scan. All results are saved and available for download in the <strong>Reports</strong> section.<br/><br/>Click the <strong>Mission Briefing</strong> button anytime to replay this walkthrough.",
    },
    onHighlightStarted: () => { clickTab("tab-basic"); },
  },
];
