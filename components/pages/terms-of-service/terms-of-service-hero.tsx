  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: "radial-gradient(ellipse 72% 75% at 50% 50%, transparent 18%, white 82%)",
        }}
      />
      <div
        className="absolute inset-0 pointer-events-none z-1 hidden dark:block"
        style={{
          background: "radial-gradient(ellipse 72% 75% at 50% 50%, transparent 18%, #111113 82%)",
        }}
      />
      ...
      <div
        ...
        style={{
          background: "linear-gradient(90deg, transparent, rgba(0,188,161,0.32) 40%, rgba(0,188,161,0.32) 60%, transparent)",
        }}
      />
