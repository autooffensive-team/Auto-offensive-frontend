...
const PrivacyBlobs = () => (
  <>
    <style>{`
      ...
      /* Spring entrance — same cubic-bezier(.34,1.4,.64,1) as AboutHero */
    ...
    >
      ...
      {/* ── Group 1 — bottom-left teal ellipse + top-right rect blob ── */}
      <g className="ph-g1">
        <ellipse
          cx="180" cy="590" rx="310" ry="220"
          fill="url(#ph_lg1)"
          filter="url(#ph_f3)"
          transform="rotate(-25 180 590)"
        />
        <rect
          x="820" y="60" width="360" height="280" rx="120"
          fill="url(#ph_lg2)"
          filter="url(#ph_f1)"
          transform="rotate(12 1000 200)"
        />
      </g>

      {/* ── Group 2 — top-left circle + bottom-right amber blob ── */}
      <g className="ph-g2">
        <circle
          cx="90" cy="120" r="160"
          fill="url(#ph_lg1)"
        ...
        />
        <ellipse
          cx="1050" cy="580" rx="270" ry="190"
          fill="url(#ph_lg3)"
          filter="url(#ph_f1)"
          transform="rotate(-8 1050 580)"
        />
      </g>

      {/* ── Group 3 — centre-right violet + lower-centre sky blob ── */}
      <g className="ph-g3">
        <circle
          cx="1120" cy="280" r="180"
          fill="url(#ph_rg4)"
          filter="url(#ph_f2)"
          opacity="0.65"
        />
        <ellipse
          cx="640" cy="680" rx="220" ry="130"
          fill="url(#ph_lg2)"
          filter="url(#ph_f1)"
          opacity="0.45"
          transform="rotate(6 640 680)"
        />
      </g>

      {/* ── Static centre ambient glow ── */}
      <ellipse
        cx="600" cy="390" rx="340" ry="210"
        fill="url(#ph_rg5)"
        filter="url(#ph_f4)"
        opacity="0.35"
      />
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 72% 75% at 50% 50%, transparent 18%, white 82%)",
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 72% 75% at 50% 50%, transparent 18%, #111113 82%)",
        }}
      />

      {/* ── Bottom accent line ── */}
      <div
        className="absolute bottom-0 left-0 right-0 h-px z-3"
        style={{
          background:
            "linear-gradient(90deg, transparent, rgba(0,188,161,0.32) 40%, rgba(0,188,161,0.32) 60%, transparent)",
        }}
      />
