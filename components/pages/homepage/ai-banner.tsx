...
export default function AiBanner() {
  ...
  return (
    <div
      ref={sectionRef}
      className="w-full bg-[#F7F5F0] px-4 pb-8 transition-colors duration-300 dark:bg-[#09090B] sm:px-5 md:px-6"
    >
      <style>{`
        @keyframes ai-banner-center-sweep {
          0% {
            opacity: 0;
            clip-path: inset(0 50% 0 50% round 1.5rem);
        ...
        .ai-banner-active .ai-banner-shell {
          animation: ai-banner-center-sweep 0.6s cubic-bezier(.16,1,.3,1) both;
        }

        .ai-banner-active .ai-banner-copy {
          animation: ai-banner-copy-left 0.5s 0.08s cubic-bezier(.16,1,.3,1) both;
        }

        .ai-banner-active .ai-banner-fox {
          animation: ai-banner-fox-right 0.55s 0.12s cubic-bezier(.16,1,.3,1) both;
        }
      `}</style>
      <div
        className={`relative pt-8 md:pt-10 lg:pt-12 ${hasEnteredView ? "ai-banner-active" : ""}`}
        style={{ fontFamily: bodyFontFamily }}
      >
        <div
          className="ai-banner-shell relative flex min-h-80 items-center justify-center gap-64 overflow-hidden rounded-3xl border border-transparent bg-[#F7F5F0] px-16 py-12 dark:border-white/5 dark:bg-[#111113] max-[900px]:flex-col max-[900px]:gap-0 max-[900px]:px-8 max-[900px]:pt-10 max-[900px]:pb-56 max-[767px]:rounded-[24px] max-[767px]:px-5 max-[767px]:pt-8 max-[767px]:pb-64"
          style={{
        ...
        >
          ...
          <div
            className="ai-banner-copy relative z-10 shrink-0 max-w-xl max-[900px]:max-w-136 max-[900px]:text-center"
            style={{
          ...
          <div
            className="ai-banner-fox pointer-events-none absolute inset-x-0 bottom-0 z-20 hidden justify-center max-[900px]:flex"
            style={{
              willChange: "transform, opacity",
            }}
          >
        ...
        <div
          className="ai-banner-fox absolute -top-10 bottom-0 z-20 flex items-end justify-center pointer-events-none max-[900px]:hidden"
          style={{
